        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        ...
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="block m-t-xs font-bold"><?=$value['name'] ." ". $value['surName']?></span>
                    ...
                    <li>
                        <a href="ourService.php"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Hizmetler</span></a>
                     
                    </li>
                    <li>
                        <a href="messages.php"><i class="fa fa-envelope"></i> <span class="nav-label">İletişim </span></a>           
                    </li>
                    <li>
                        <a href="gallery.php"><i class="fa fa-photo"></i> <span class="nav-label">Galeri</span>  </a>
                    </li>
                    <li>
                        <a href="siteSetting.php"><i class="fa fa-gear"></i> <span class="nav-label">Site Ayarları</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="../index.php"><i class="fa fa-sign-out"></i> <span class="nav-label">Siteye Git</span></a>
