                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content ">
                        ...
                        <?php foreach ($service as $value) { ?>
                            ...
                            <div class="col-lg-6">
                            <img src="../../public/uploads/<?= $value['serviceImg']?>"  class="img-fluid" alt="">
                            </div>
                                ...
                                <input id="logo" type="file" name="serviceImg" class="custom-file-input">
                                    ...
                                    <button type="submit" name="updateServicePhoto" class="float-right btn btn-secondary mt-2 ">Fotoğrafı Güncelle</button>
                                </div>
